...
<body>
    <div id="wrapper">
        ...
        <div class="section__container header__container">
            <h3>Bicep Curls</h3>
            <iframe width="560" height="315" src="https://www.youtube.com/embed/ykJmrZ5v0Oo?si=_7eNNVAUQw7CxkhE" 
                title="YouTube video player" frameborder="0" 
                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" 
                allowfullscreen></iframe>
            
            <h3>Tricep Extensions</h3>
            <iframe width="560" height="315" src="https://www.youtube.com/embed/_gsUck-7M74?si=8k1PkTWfDLc_WukG" 
                title="YouTube video player" frameborder="0" 
                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" 
                allowfullscreen></iframe>
            
            <h3>Pronated Curls</h3>
            <iframe width="560" height="315" src="https://www.youtube.com/embed/gdbjLvMqJKk?si=ppeFWE6Dg3xMTi_C" 
                title="YouTube video player" frameborder="0" 
                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" 
                allowfullscreen></iframe>
            
            <h3>Hammer Curls</h3>
            <iframe width="560" height="315" src="https://www.youtube.com/embed/TwD-YGVP4Bk?si=2Iu6i_7l56u-bVbA" 
                title="YouTube video player" frameborder="0" 
                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" 
                allowfullscreen></iframe>

            <h3>Tricep Pushdowns</h3>
            <iframe width="560" height="315" src="https://www.youtube.com/embed/8WL0m0vLAPo?si=dJypVoEQ74g7aVke" 
                title="YouTube video player" frameborder="0" 
                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" 
                allowfullscreen></iframe>          
        </div>
