...
<body>
    <div id="wrapper">
      ...
      <div class="table-container">
        <h1 class="heading-form">Daily Workout Tracker</h1>
        ...
        <table id="intake-table">
          ...
          <tbody>
            <tr class="intake-row">
              <td><input type="text" name="body" class="body-input" /></td>
              <td><input type="number" name="min" class="min-input" /></td>
            </tr>
          </tbody>
        </table>
        <button type="submit">Send</button>
        </form>
        <button id="add-row-button">Add Workout</button>
        <button id="delete-row-button">Delete Workout</button>
      </div>
    ...
    <script>
      ...
      function calculateTotal() {
        ...
        $(".intake-row").each(function () {
          var reps = parseFloat($(this).find(".min-input").val()) || 0;
